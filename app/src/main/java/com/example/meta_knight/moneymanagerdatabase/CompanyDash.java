...
public class CompanyDash extends AppCompatActivity implements RecyclerItemTouchHelper.RecyclerItemTouchHelperListener {
    ...
    private void InitiateRecylerView() {
        ...
        ItemTouchHelper.SimpleCallback itemTouchHelperMove = new RecyclerItemTouchHelper(0, ItemTouchHelper.UP, this);
        new ItemTouchHelper(itemTouchHelperMove).attachToRecyclerView(recyclerView);
